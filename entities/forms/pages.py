...
class PlaceForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['title', 'directions', 'cities', 'local_classes', 'types', 'locations', 'description', 'image',
                  'links', 'owns', 'owners', 'contributors', 'author']
...
class SchoolForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['title', 'directions', 'cities', 'local_classes', 'locations', 'employees', 'description', 'image',
                  'links', 'contacts', 'owns', 'owners', 'contributors', 'author']
...
class ShopForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['title', 'directions', 'cities', 'types', 'locations', 'employees', 'description',
                  'image', 'links', 'contacts', 'owns', 'owners', 'contributors', 'author']
...
class ResourceForm(forms.ModelForm):
    class Meta:
        model = Resource
        fields = ['title', 'directions', 'cities', 'description', 'image', 'links', 'contacts', 'owns', 'owners',
                  'contributors', 'author']
